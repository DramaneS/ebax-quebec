...
public class InvoiceResource {
    ...
    public ResponseEntity<Invoice> partialUpdateInvoice(
        ...
        Optional<Invoice> result = invoiceRepository
            ...
            .map(existingInvoice -> {
                if (invoice.getNameCustumer() != null) {
                    existingInvoice.setNameCustumer(invoice.getNameCustumer());
                }
                if (invoice.getAdress() != null) {
                    existingInvoice.setAdress(invoice.getAdress());
                }
                if (invoice.getPhone() != null) {
                    existingInvoice.setPhone(invoice.getPhone());
                }
