...
public class ProjectResource {
    ...
    public ResponseEntity<Project> partialUpdateProject(
        ...
        Optional<Project> result = projectRepository
            ...
            .map(existingProject -> {
                if (project.getNameBuilding() != null) {
                    existingProject.setNameBuilding(project.getNameBuilding());
                }
                if (project.getFullAddressBuilding() != null) {
                    existingProject.setFullAddressBuilding(project.getFullAddressBuilding());
                }
                if (project.getNumberHousingUnits() != null) {
                    existingProject.setNumberHousingUnits(project.getNumberHousingUnits());
                }
                if (project.getElectricitySupplier() != null) {
                    existingProject.setElectricitySupplier(project.getElectricitySupplier());
                }
                if (project.getHydroQuebecContractNumber() != null) {
                    existingProject.setHydroQuebecContractNumber(project.getHydroQuebecContractNumber());
                }
                if (project.getHydroQuebecMeterNumber() != null) {
                    existingProject.setHydroQuebecMeterNumber(project.getHydroQuebecMeterNumber());
                }
                if (project.getIfSeveralMeters() != null) {
                    existingProject.setIfSeveralMeters(project.getIfSeveralMeters());
                }
                if (project.getSpecifyMeteIntended() != null) {
                    existingProject.setSpecifyMeteIntended(project.getSpecifyMeteIntended());
                }
                if (project.getHydroQuebecAccountNumber() != null) {
                    existingProject.setHydroQuebecAccountNumber(project.getHydroQuebecAccountNumber());
                }
                if (project.getFileNumber() != null) {
                    existingProject.setFileNumber(project.getFileNumber());
                }
                if (project.getTypeBuillding() != null) {
                    existingProject.setTypeBuillding(project.getTypeBuillding());
                }
                if (project.getNatureProject() != null) {
                    existingProject.setNatureProject(project.getNatureProject());
                }
                if (project.getStartDateWork() != null) {
                    existingProject.setStartDateWork(project.getStartDateWork());
                }
                if (project.getEndDateWork() != null) {
                    existingProject.setEndDateWork(project.getEndDateWork());
                }
